...
export default function Career(): ReactElement {
    ...
    return (<div>
        ...
        <div className='experience-task-style'>
            ...
            <h1 className="jobtitle">Rakuten | Software Engineer | Tokyo, Japan	 				               	   	       	        2017 - 2020</h1>
            <ul className="tasklist">
            ...
            <h1 className="jobtitle">Voltage Entertainment Inc. | Software Engineer | San Francisco, CA	2014 - 2016</h1>
            <ul className="tasklist">
