            ...
            <div className='flex min-h-screen flex-col items-center sm:flex-row'>
                ...
                <div className='my-8 sm:my-0 sm:ml-16'>
                    ...
                    <div className='ps-px pr-64 pb-10 font-serif4 text-xl  text-justify tracking-wide space-y-5'>
                        ...
                        <p>Most of the frontend tools used here were new to me. Learning and trial and error took some time, but I've spent about 4-5 weeks to get to where you see now, including all the infrastructure setups.</p>
